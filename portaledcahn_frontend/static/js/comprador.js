        ...
        $('<tr>').append(
            $('<td>',{'data-label':'Comprador'}).append(
              ...
              $('<td>',{'data-label':'Título del Proceso'}).append(
                resultados[i]&&resultados[i]._source&&resultados[i]._source.doc&&resultados[i]._source.doc.tender&&resultados[i]._source.doc.tender.title?$('<a>',{class:'enlaceTablaGeneral',href:'/proceso/'+encodeURIComponent(resultados[i]._source.doc.ocid)}).text(resultados[i]._source.doc.tender.title):$('<span>',{class:'textoColorGris'}).text('No Disponible')
              ),
              $('<td>',{'data-label':'Categoría de Compra'}).append(
                resultados[i]&&resultados[i]._source&&resultados[i]._source.doc&&resultados[i]._source.doc.tender&&resultados[i]._source.doc.tender.procurementMethodDetails?resultados[i]._source.doc.tender.procurementMethodDetails:$('<span>',{class:'textoColorGris'}).text('No Disponible')
              ),
          ...
          $('<td>',{'data-label':'Estado'}).append(
            resultados[i]&&resultados[i]._source&&resultados[i]._source.extra&&resultados[i]._source.extra.lastSection?resultados[i]._source.extra.lastSection:$('<span>',{class:'textoColorGris'}).text('No Disponible')
                ...
                $('<td>',{'data-label':'Monto Contratado' ,class:'textoAlineadoDerecha'}).append(
                    resultados[i]._source.doc.compiledRelease&&resultados[i]._source.doc.compiledRelease.tender&&resultados[i]._source.doc.compiledRelease.tender.extra&&resultados[i]._source.doc.compiledRelease.tender.extra&&Validar(resultados[i]._source.doc.compiledRelease.tender.extra.sumContracts)?
                [ValorMoneda(resultados[i]._source.doc.compiledRelease.tender.extra.sumContracts),$('<span>',{class:'textoColorPrimario',text:' HNL'})]:''
